...
var _excluded3 = ["disableAnimation", "margin", "shrink", "variant", "className"];
...
var InputLabel = React3.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime3.jsx)(InputLabelRoot, _extends({
    "data-shrink": shrink,
    ownerState,
    ref,
...
true ? InputLabel.propTypes = {
   ...
   * @default 'normal'
   */
  size: import_prop_types3.default.oneOfType([import_prop_types3.default.oneOf(["normal", "small"]), import_prop_types3.default.string]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var Popover = React7.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent_default(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
...
var NativeSelectInput = React9.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime10.jsxs)(React9.Fragment, {
...
var Select = React11.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(React11.Fragment, {
    children: React11.cloneElement(InputComponent, _extends({
...
var TextField = React12.forwardRef(function TextField2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTextField"
  });
...
//# sourceMappingURL=chunk-IGGDOHWT.js.map
