...
function DrawingProvider(props) {
  ...
  const isPointInside = React2.useCallback(({
    x: x2,
    y: y2
  }) => x2 >= drawingArea.left && x2 <= drawingArea.left + drawingArea.width && y2 >= drawingArea.top && y2 <= drawingArea.top + drawingArea.height, [drawingArea]);
...
var HighlightedContext = React14.createContext({
  isInitialized: false,
  data: {
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React15.useContext(HighlightedContext);
  if (!isInitialized) {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React16.useMemo(() => {
  ...
  const providerValue = React16.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
var ZAxisContext = React17.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React17.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React19.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React20.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React20.createContext(init));
...
function useChartId() {
  const {
    chartId
  } = React21.useContext(DrawingContext);
  return React21.useMemo(() => chartId, [chartId]);
}
...
var ColorContext = React28.createContext({});
if (true) {
...
function ColorProvider(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(ColorContext.Provider, {
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React29.useRef({
    x: -1,
    y: -1
  });
  React29.useEffect(() => {
...
var _excluded3 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
...
var ChartsSurface = React30.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
var useDefaultizeAxis = (inXAxis, inYAxis) => {
  const xAxis = React33.useMemo(() => defaultizeAxis(inXAxis, "x"), [inXAxis]);
  const yAxis = React33.useMemo(() => defaultizeAxis(inYAxis, "y"), [inYAxis]);
  return [xAxis, yAxis];
};

// node_modules/@mui/x-charts/esm/ChartContainer/useChartContainerProps.js
var _excluded4 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children"];
...
var ChartContainer = React34.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime13.jsx)(ColorProvider, _extends({}, colorProviderProps, {
      children: (0, import_jsx_runtime13.jsx)(SeriesContextProvider, _extends({}, seriesContextProps, {
        children: (0, import_jsx_runtime13.jsx)(CartesianContextProvider, _extends({}, cartesianContextProps, {
            ...
            children: (0, import_jsx_runtime13.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime13.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime13.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime13.jsx)(ChartsAxesGradients, {}), children]
                }))
              }))
            })
          }))
...
// node_modules/@mui/x-charts/esm/ResponsiveChartContainer/useResponsiveChartContainerProps.js
var _excluded5 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis"];
...
var ResponsiveChartContainer = React36.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function ChartsText(props) {
  ...
  const wordsByLines = React37.useMemo(() => getWordsByLines({
    style,
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime17.jsxs)(AxisRoot, {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)(React41.Fragment, {
...
var Portal = React42.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime19.jsx)(React42.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime19.jsx)(React42.Fragment, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(React44.Fragment, {
...
function useColorProcessor(seriesType) {
  const colorProcessors = React47.useContext(ColorContext);
  if (!seriesType) {
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React48.useContext(ZAxisContext);
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React50.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React50.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React50.useMemo(() => {
...
function ChartsTooltip(props) {
  ...
  const {
    item,
    axis
  } = React51.useContext(InteractionContext);
...
function LegendPerItem(props) {
  ...
  const isRTL = theme.direction === "rtl";
  const drawingArea = useDrawingArea();
  const labelStyle = React52.useMemo(
  ...
  const padding = React52.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React52.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React52.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React52.useMemo(() => {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(LegendPerItem, _extends({}, other, {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(React56.Fragment, {
    children: [(0, import_jsx_runtime30.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime30.jsx)("rect", _extends({
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay
  }));
}
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React58.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime32.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime32.jsx)(ChartsAxisHighlightPath, {
...
//# sourceMappingURL=chunk-SAHSNSUO.js.map
